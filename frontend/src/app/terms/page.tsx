          ...
          <div className="p-8">
            ...
            <div className="space-y-6 text-gray-700">
              <section>
                ...
                <p>
                  本利用規約（以下、「本規約」といいます。）は、[あなたのサービス名]（以下、「本サービス」といいます。）の利用に関する条件を、本サービスを利用するすべてのユーザー（以���、「ユーザー」といいます。）と当社の間で定めるものです。
                </p>
              </section>
              ...
              <section>
                ...
                <p>
                  当社は、以下のいずれかの事由があると判断した場合、ユーザーに事前に通知することなく本サービスの全部または一部の提供を停止または中断することができるもの��します。
                </p>
                <ul className="list-disc list-inside mt-2 pl-4">
              ...
              <section>
                <h2 className="text-2xl font-semibold mb-3">第7条（準拠法・裁判管轄）</h2>
                <p>
